...
def _snr_report(snr_values: list[float]) -> str:
    ...
    if pct_low > 30:
        ...
        grade = "🟡 FAIR"
        note = (
            "Moderate noise; classical scoring may struggle with the weakest spectra."
        )
    else:
        grade = "🟢 GOOD"
...
def _chimericity_report(
    ...
    if pct > 25:
        ...
        grade = "🟢 LOW"
        impact = "Chimericity is low.  Classical cosine scoring should perform well."
...
def _pipeline_recommendation(
    ...
    details = (
        f"\n\n*Decision scores — Classical: {score_classical:+d},  ML: {score_ml:+d}*\n"
    )
